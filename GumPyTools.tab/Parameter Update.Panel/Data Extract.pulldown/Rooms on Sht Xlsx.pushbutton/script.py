...
for (room_name_blp, room_number, sheet_number, sheet_name, sheet_dept,
    ...
    worksheet.write(row, 2, str(sheet_number))
    worksheet.write(row, 3, sheet_name)
    worksheet.write(row, 4, sheet_dept)
    worksheet.write(row, 5, sheet_dwg_type)
    worksheet.write(row, 6, assoc_level)
    row += 1
