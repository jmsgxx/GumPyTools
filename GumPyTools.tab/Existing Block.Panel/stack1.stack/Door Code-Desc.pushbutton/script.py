...
with Transaction(doc, __title__) as t:
    ...
    door_panel_lst              = get_list('Door Panel Key')
    door_op_lst                 = get_list('Door Operation Key')
    door_lock_lst               = get_list('Door Lock Function Key')
    door_cons_lst               = get_list('Door Construction Key')
    door_prot_pl_wl_lst         = get_list('Door Protection Pull Key')
    door_prot_pl_wl_htx_lst     = get_list('Door Protection Pull Height Key')
    door_prot_ps_tr_lst         = get_list('Door Protection Push Key')
    door_prot_ps_tr_htx_lst     = get_list('Door Protection Push Height Key')
